...
def derive_thermosteric_anomaly(
    ...
    """Derive thermosteric anomaly from salinity and temperature.
...
def derive_sound_velocity_c(
    ...
    """Derive sound velocity using Chen and Millero (1977) formula.
...
def derive_sound_velocity_d(
    ...
    """Derive sound velocity using Del Grosso (1974) formula.
...
def derive_sound_velocity_w(
    ...
    """Derive sound velocity using Wilson (1960) formula.
...
def derive_specific_conductance(
    ...
    """Derive specific conductance from temperature and conductivity.
...
def derive_average_sound_velocity(
    ...
    """Compute Average Sound Velocity (ASV) over a profile.
