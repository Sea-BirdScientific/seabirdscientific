...
def interpret_sbs_variable(sbs_var):
   ...
   # strain gauge pressure
    ...
    # FREQUENCY OUTPUT
    elif sbs_var in  {'f0', 'f1', 'f2', 'f3', 'f4', 'f5', 'f6', 'f7', 'f8', 'f9', 'f10', 'f11', 'f12', 'f13', 'f14', 'f15', 'f16', 'f17', 'f18',
            'f19', 'f20', 'f21', 'f22', 'f23', 'f24', 'f25', 'f26', 'f27', 'f28', 'f29', 'f30', 'f31', 'f32', 'f33', 'f34', 'f35', 'f36'}:
        kvar_name = sbs_var
        kvar_units = 'Hz'
        
     # VOLTAGE OUTPUT
    elif sbs_var in  {'v0', 'v1', 'v2', 'v3', 'v4', 'v5', 'v6', 'v7', 'v8', 'v9', 'v10', 'v11', 'v12', 'v13', 'v14', 'v15'}:
        kvar_name = sbs_var
        kvar_units = 'V'
   ...
   # POTENTIAL TEMPEATURE ANOMALY 
    ...
    # WETLABS AC3
        ...
        kvar_units = '1/m'
    # WETLABS CDOM
    elif sbs_var in  {'wetCDOM', 'wetCDOM1', 'wetCDOM2', 'wetCDOM3', 'wetCDOM4', 'wetCDOM5', 'wetCDOMdiff'}:
        kvar_name = sbs_var
        kvar_units = 'mg/m^3'
    ...
    # FDOM
        ...
        kvar_units = '?g/l'
    # WETSTAR 
    elif sbs_var in  {'wetStar', 'wetStar1', 'wetStar2', 'wetStar3', 'wetStar4', 'wetStar5', 'wetStardiff'}:
        kvar_name = sbs_var
        kvar_units = 'mg/m^3'
    ...
    # SEAPOINT TURBIDITY
        ...
        kvar_units = 'FTU'
    # WETLABS ECO BB 
    elif sbs_var in  {'turbWETbb0', 'turbWETbb1', 'turbWETbb2', 'turbWETbb3', 'turbWETbb4', 'turbWETbb5', 'turbWETbbdiff'}:
        kvar_name = sbs_var
        kvar_units = 'm^-1/sr'
    # WETLABS ECO
    elif sbs_var in  {'turbWETntu0', 'turbWETntu1', 'turbWETntu2', 'turbWETntu3', 'turbWETntu4', 'turbWETntu5', 'turbWETntudiff'}:
        kvar_name = sbs_var
        kvar_units = 'NTU'
    # WETLABS SEAOWL
    ...
    elif sbs_var in  {'CStarAt', 'CStarAt0', 'CStarAt1', 'CStarAt2', 'CStarAt3', 'CStarAt4', 'CStarAt5', 'CStarAtdiff'}:
        kvar_name = sbs_var
        kvar_units = '1/m'
    ...
    elif sbs_var in  {'CStarTr', 'CStarTr0', 'CStarTr1', 'CStarTr2', 'CStarTr3', 'CStarTr4', 'CStarTr5', 'CStarTrdiff'}:
        kvar_name = sbs_var
        kvar_units = r'%'
