...
def read_hex_file(
    filepath: str, instrument_type: InstrumentType, enabled_sensors: List[Sensors], moored_mode = False, 
) -> pd.DataFrame:
...
def preallocate_dataframe(
    instrument_type: InstrumentType, line: str, enabled_sensors: List[Sensors], moored_mode: bool, data_length: int
) -> pd.DataFrame:
...
def read_SBE19plus_format_0(hex: str, enabled_sensors: List[Sensors], moored_mode = False):
    ...
    for sensor in Sensors:
        if sensor in enabled_sensors:
            ...
            if sensor in [Sensors.ExtVolt0, Sensors.ExtVolt1, Sensors.ExtVolt2, Sensors.ExtVolt3, Sensors.ExtVolt4, Sensors.ExtVolt5]:
            ...
            if sensor == Sensors.SBE38:
                results[HexDataTypes.SBE38temperature.value] = int(hex[n:n + HEX_LENGTH['SBE38temperature']], 16) / 100000 - 10
            ...
            if sensor == Sensors.GTD:
                ...
                results[HexDataTypes.GTDtemperature.value] = int(hex[n:n + HEX_LENGTH['GTDtemperature']], 16) / 10000 - 10
            ...
            if sensor == Sensors.DualGTD:
                ...
                n += HEX_LENGTH['GTDpressure']
                results[HexDataTypes.GTDtemperature2.value] = int(hex[n:n + HEX_LENGTH['GTDtemperature']], 16) / 10000 - 10
                n += HEX_LENGTH['GTDtemperature']
            ...
            if sensor == Sensors.SBE63:
                ...
                results[HexDataTypes.SBE63temperature.value] = int(hex[n:n + HEX_LENGTH['SBE63temperature']], 16) / 1000000 - 1
